...
export const AddAutoDealershipDialog: React.FC<{
  open: boolean;
  handleClose: () => void;
}> = ({ handleClose, open }) => {
 const dialogTitle = "autoDealership";
 const {addAutoDealerShip,isPostAutoDealerShipLoading} = useAutoDealerShip()
  ...
  const validateInputs = () => {
    ...
    addAutoDealerShip(
      { title: title.value, description: des.value,everyThingHeading:des.value,promotedPlacementHeading:des.value },
  ...
  return (
    <CustomizedDialog
      ...
      disableSubmit={isPostAutoDealerShipLoading}
